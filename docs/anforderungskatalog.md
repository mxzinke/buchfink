...
| Vorsteuerabzug erst nach fehlerfreier Prüfung oder dokumentierter Übersteuerung | ❌ | internal/service/einvoice_notice.go:12 blockiert ausdrücklich nie, internal/service/posting_service.go:205-211 fragt `ValidationErrors` nicht ab | 5 |

**Stand.** Der Empfang ist der ausgereifteste Teil des Moduls: gelesen, geprüft, archiviert, und seit Welle 5b steht der beanstandete Beleg in einer Klärungsliste statt in einer Statusanzeige, die niemand öffnet. Bis zur letzten Station: der Vorsteuerabzug ist an das Prüfergebnis nicht gekoppelt. Welle 5.
...
| Freistellungsbescheinigung mit Gültigkeitsdauer im Stammsatz, Meldung bei Ablauf | ⛔ | Bauleistungen und Gebäudereinigung nach § 13b Abs. 2 Nr. 4 UStG sind kein Steuerfall von Buchfink; internal/domain/contact.go:39-51 und die übrigen Felder des Kontakts führen entsprechend keines dafür | – |
| Betragsgrenzen von 5.000 Euro je wirtschaftlichem Vorgang geprüft | ❌ | internal/service/posting_service.go:1056-1081 prüft nur Land und USt-IdNr. | 3 |
...
| Prüfung automatisiert vor jeder steuerfreien innergemeinschaftlichen Lieferung | ❌ | internal/service/invoice_service.go:894-913 prüft nur, dass ein nichtleeres Feld `VatID` existiert und das Land in der EU liegt | 5 |
| Fehlender oder negativer Prüfnachweis blockiert oder erzwingt eine dokumentierte Übersteuerung | 🟡 | internal/domain/invoice.go:512-515 blockiert bei fehlender USt-IdNr., und zwar vor der Nummernvergabe; eine ungültige blockiert nicht, weil sie nie geprüft wird | 5 |
...
| Kriterium | Status | Fundstelle / Grund | Welle |
|---|---|---|---|
| Vorsteuerabzug an das Vorliegen einer geprüften Rechnung gekoppelt | ❌ | internal/service/posting_service.go:205-211 liest die Validierungsbefunde des Belegs nicht; Warnungen blockieren ausdrücklich nie (internal/service/einvoice_notice.go:12) | 5 |
| Gemischt genutzte Wirtschaftsgüter tragen einen Vorsteuerschlüssel mit Aufteilungsmaßstab und Begründung | ❌ | internal/accounting/tax_skr04.go:162-171 kennt nur volle Vorsteuer | 5 |
...
| Bagatellgrenzen des § 44 UStDV angewendet | ❌ | internal/accounting/tax_params.go:29-32 und die übrigen Werte in internal/accounting/tax_params.go kennen nur Bewirtung, Kleinbetragsgrenze und die Ertragsteuersätze | 5 |
...
| E. Ausgangsrechnungen und E-Rechnung | RECH-01 bis RECH-10 | 28 | 6 | 3 | 6 | 43 |
| F. Umsatzsteuer, Aufzeichnung und Meldewesen | UST-01 bis UST-09 | 13 | 5 | 11 | 13 | 42 |
