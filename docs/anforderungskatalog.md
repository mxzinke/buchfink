...
Die Spalte Welle dokumentiert die frühere Umsetzungsplanung und ist keine aktuelle Terminzusage. Offene Arbeiten stehen auf der [Roadmap](roadmap.md). Ältere Zeilenangaben können durch Umbauten verschoben sein; bei der Prüfung ist die benannte Funktion im aktuellen Code maßgeblich.
